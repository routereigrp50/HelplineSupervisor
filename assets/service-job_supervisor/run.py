...
from job_supervisor import JobSupervisor as JobSupervisor
import json
...
if __name__ == "__main__":
    h_log.create_log(4, "run.__main__", "Attempting to start service job_supervisor")
    j_sv = JobSupervisor()
    '''
    ...
    j_sv.api_set_config(configuration["api"])
    ...
    '''
    '''
    h_log.create_log(4, "run.__main__", f"Successfully started service job_supervisor")
    j_sv.api_run()
